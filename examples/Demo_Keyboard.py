'''
Working demo of keypad of MessengerPi
SHIFT button - to switch between Capital (ABC), Small (abc) & Special (*/#) characters,
CTRL button - to switch between demo font size
Ext button - clears screen
